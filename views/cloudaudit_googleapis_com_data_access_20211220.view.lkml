# The name of this view in Looker is "Cloudaudit Googleapis Com Data Access 20211220"
view: cloudaudit_googleapis_com_data_access_20211220 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `bq_generated.cloudaudit_googleapis_com_data_access_20211220`
    ;;
...
# The name of this view in Looker is "Cloudaudit Googleapis Com Data Access 20211220 Protopayload Auditlog Servicedata V1 Bigquery Job Completed Event Job Job Statistics Referenced Tables"
view: cloudaudit_googleapis_com_data_access_20211220__protopayload_auditlog__servicedata_v1_bigquery__job_completed_event__job__job_statistics__referenced_tables {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
